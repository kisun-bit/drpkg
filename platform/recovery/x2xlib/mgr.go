...
func (x *X2XLib) SelectWindowsBestVirtualDriver(
	...
	err = x.db.
		...
		Where("driver.os = ?", defs.OsWindows).
...
func (x *X2XLib) pickWindowsDriver(
	...
	ntVer, _ := defs.OsNTVersion[windowsVersion]
	if ntVer >= defs.NT62 || ignoreCheckSignature {
